...
void start_threads(pthread_mutex_t *forks, int num_philosophers, \
...
void start_threads(pthread_mutex_t *forks, int num_philosophers, int min_dur, int max_dur, int num_forks)
{
  int i;
  pthread_t threads[num_philosophers];
